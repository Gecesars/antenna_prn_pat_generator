        ...
        with self._lock:
            ...
            try:
                ...
                if "PyDesktopPlugin.dll" not in msg_first:
                    raise RuntimeError(f"Failed to connect to AEDT/HFSS via PyAEDT: {e_first}") from e_first
                ...
                if self._hfss is None:
                    ...
                    raise RuntimeError(f"Failed to connect to AEDT/HFSS via PyAEDT: {e_first}. {help_msg}") from e_first
