...
paramteros = {
    ...
    "n_outputs": 4,
    "n_sections": 2,
    "sec_len_mm": 416.7,              # comprimento de cada λ/4
    "len_inner_mm": 833.4,            # soma das duas seções λ/4
    "len_outer_mm": 900,              # pequeno excedente
    "d_int_tube": 37.686,             # diâmetro interno tubo 44 mm OD, 3.157 mm parede
    "d_out_50ohm": 12.3,              # diâmetro central para linha 50 ohms (ver cálculo)
    "main_diams": [6.84, 13.08,       # Porta 4: Z1, Z2
                   5.01, 12.31,       # Porta 3: Z1, Z2
                   1.27, 9.96,        # Porta 1: Z1, Z2
                   1.27, 9.96],       # Porta 2: Z1, Z2
}
